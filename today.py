...
USER_NAME = os.environ['USER_NAME'] # 'baksho'
...
if __name__ == '__main__':
    """
    Suvinava Basak (baksho), 2024-2026
    """
    ...
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(1993, 7, 26))
    ...
    for svg_file in ('dark_mode_a.svg', 'light_mode_a.svg'):
